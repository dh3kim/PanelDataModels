...
!**************************************************************
 ...
 input = adjustl(trim(datapath))//"GrowthSpatialData_M31.raw"
...
do i = 2, KVars
  write(10, "(2F6.3)" ) beta(i), beta(i)/sqrt(var_beta(i,i))
enddo
  write(10, "(2F6.3)" ) beta(1), beta(1)/sqrt(var_beta(1,1))
  write(10, "(3F6.3)" )   delta(1), sqrt(delta(3)), sqrt(sigma_sq)
